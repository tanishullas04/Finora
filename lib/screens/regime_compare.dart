...
class _RegimeCompareScreenState extends State<RegimeCompareScreen> {
  ...
  double _calculateOldRegimeTax(double income, double deductions) {
    ...
    double taxableIncome = (income - 50000 - deductions).clamp(
      0,
      double.infinity,
    );
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    "Regular Income: ${_formatCurrency(_totalIncome - _totalCapitalGains + ((_ltcgTax > 0 || _totalCapitalGains > 0) ? 0 : 0))}",
                    style: const TextStyle(fontSize: 13),
                  ),
                  if (_totalCapitalGains > 0)
                    Text(
                      "Capital Gains: ${_formatCurrency(_totalCapitalGains)}",
                  ...
                  Text(
                    "Total Income: ${_formatCurrency(_totalIncome)}",
                    style: const TextStyle(
                      fontSize: 13,
                      fontWeight: FontWeight.bold,
                    ),
                  ...
                  Text(
                    "Deductions: ${_formatCurrency(_totalDeductions)}",
                ...
                Expanded(
                  child: _regimeCard(
                    ...
                    [
                      ...
                      if (_totalGSTTax > 0)
                        "GST: ${_formatCurrency(_totalGSTTax)}",
                    ],
                  ),
                ),
